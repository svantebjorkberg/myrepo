...
/**
 * This is the item provider adapter for a {@link se.remember.Customer} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 RememberPackage.Literals.CUSTOMER__CUSTOMER_ID,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 RememberPackage.Literals.CUSTOMER__NAME,
				 true,
				 false,
				 false,
	...
	protected void addProjectsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Customer_projects_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Customer_projects_feature", "_UI_Customer_type"),
				 RememberPackage.Literals.CUSTOMER__PROJECTS,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addNodesPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Customer_nodes_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Customer_nodes_feature", "_UI_Customer_type"),
				 RememberPackage.Literals.CUSTOMER__NODES,
				 true,
				 false,
				 true,
				 null,
